...
public class OmniController : MonoBehaviour {
	...
	void Start () {
		...
		_0deg = gameObject.AddComponent<AudioSource>();
		_90deg = gameObject.AddComponent<AudioSource>();
		_180deg = gameObject.AddComponent<AudioSource>();
		_270deg = gameObject.AddComponent<AudioSource>();
